...
EXTCONST char* const PL_op_name[] = {
	...
	"coreargs",	/* 427: CORE:: subroutine */
	"runcv",	/* 428: __SUB__ */
	"fc",	/* 429: fc */
	"padcv",	/* 430: private subroutine */
	"introcv",	/* 431: private subroutine */
	"clonecv",	/* 432: private subroutine */
	"padrange",	/* 433: list of private variables */
	"refassign",	/* 434: lvalue ref assignment */
	"lvref",	/* 435: lvalue ref assignment */
	"lvrefslice",	/* 436: lvalue ref assignment */
	"lvavref",	/* 437: lvalue array reference */
	"anonconst",	/* 438: anonymous constant */
	"freed",	/* 439: freed op */
};
#endif
...
EXTCONST char* const PL_op_desc[] = {
	...
	"CORE:: subroutine",	/* 427: coreargs */
	"__SUB__",	/* 428: runcv */
	"fc",	/* 429: fc */
	"private subroutine",	/* 430: padcv */
	"private subroutine",	/* 431: introcv */
	"private subroutine",	/* 432: clonecv */
	"list of private variables",	/* 433: padrange */
	"lvalue ref assignment",	/* 434: refassign */
	"lvalue ref assignment",	/* 435: lvref */
	"lvalue ref assignment",	/* 436: lvrefslice */
	"lvalue array reference",	/* 437: lvavref */
	"anonymous constant",	/* 438: anonconst */
	"freed op",	/* 439: freed */
};
#endif
...
EXTCONST U16  PL_op_private_bitdefs[] = {
    ...
    0x4250, 0x0003, /* chomp, schomp, ncomplement, scomplement, sin, cos, exp, log, sqrt, int, hex, oct, abs, length, ord, chr, chroot, rmdir */
    0x4250, 0x0067, /* pow, multiply, i_multiply, divide, i_divide, modulo, i_modulo, add, i_add, subtract, i_subtract, concat, left_shift, right_shift, nbit_and, nbit_xor, nbit_or */
