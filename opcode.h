...
EXTCONST char* const PL_op_name[] = {
	...
	"coreargs",	/* 412: CORE:: subroutine */
	"runcv",	/* 413: __SUB__ */
	"fc",	/* 414: fc */
	"padcv",	/* 415: private subroutine */
	"introcv",	/* 416: private subroutine */
	"clonecv",	/* 417: private subroutine */
	"padrange",	/* 418: list of private variables */
	"refassign",	/* 419: lvalue ref assignment */
	"lvref",	/* 420: lvalue ref assignment */
	"lvrefslice",	/* 421: lvalue ref assignment */
	"lvavref",	/* 422: lvalue array reference */
	"anonconst",	/* 423: anonymous constant */
	"freed",	/* 424: freed op */
};
#endif
...
EXTCONST char* const PL_op_desc[] = {
	...
	"CORE:: subroutine",	/* 412: coreargs */
	"__SUB__",	/* 413: runcv */
	"fc",	/* 414: fc */
	"private subroutine",	/* 415: padcv */
	"private subroutine",	/* 416: introcv */
	"private subroutine",	/* 417: clonecv */
	"list of private variables",	/* 418: padrange */
	"lvalue ref assignment",	/* 419: refassign */
	"lvalue ref assignment",	/* 420: lvref */
	"lvalue ref assignment",	/* 421: lvrefslice */
	"lvalue array reference",	/* 422: lvavref */
	"anonymous constant",	/* 423: anonconst */
	"freed op",	/* 424: freed */
};
#endif
...
EXTCONST U16  PL_op_private_bitdefs[] = {
    ...
    0x4170, 0x0003, /* chomp, schomp, ncomplement, scomplement, sin, cos, exp, log, sqrt, int, hex, oct, abs, str_length, length, ord, chr, chroot, rmdir */
    0x4170, 0x0067, /* pow, multiply, i_multiply, divide, i_divide, modulo, i_modulo, add, i_add, subtract, i_subtract, concat, left_shift, right_shift, nbit_and, nbit_xor, nbit_or, uint_lshift, uint_rshift, int_add, int_subtract, str_concat */
