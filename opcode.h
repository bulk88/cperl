...
EXTCONST char* const PL_op_name[] = {
	...
	"coreargs",	/* 410: CORE:: subroutine */
	"runcv",	/* 411: __SUB__ */
	"fc",	/* 412: fc */
	"padcv",	/* 413: private subroutine */
	"introcv",	/* 414: private subroutine */
	"clonecv",	/* 415: private subroutine */
	"padrange",	/* 416: list of private variables */
	"refassign",	/* 417: lvalue ref assignment */
	"lvref",	/* 418: lvalue ref assignment */
	"lvrefslice",	/* 419: lvalue ref assignment */
	"lvavref",	/* 420: lvalue array reference */
	"anonconst",	/* 421: anonymous constant */
	"freed",	/* 422: freed op */
};
#endif
...
EXTCONST char* const PL_op_desc[] = {
	...
	"CORE:: subroutine",	/* 410: coreargs */
	"__SUB__",	/* 411: runcv */
	"fc",	/* 412: fc */
	"private subroutine",	/* 413: padcv */
	"private subroutine",	/* 414: introcv */
	"private subroutine",	/* 415: clonecv */
	"list of private variables",	/* 416: padrange */
	"lvalue ref assignment",	/* 417: refassign */
	"lvalue ref assignment",	/* 418: lvref */
	"lvalue ref assignment",	/* 419: lvrefslice */
	"lvalue array reference",	/* 420: lvavref */
	"anonymous constant",	/* 421: anonconst */
	"freed op",	/* 422: freed */
};
#endif
...
EXTCONST U16  PL_op_private_bitdefs[] = {
    ...
    0x4170, 0x0067, /* pow, multiply, i_multiply, divide, i_divide, modulo, i_modulo, add, i_add, subtract, i_subtract, concat, left_shift, right_shift, nbit_and, nbit_xor, nbit_or, int_lshift, int_rshift, int_add, int_subtract, str_concat */
